                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'project_location'])
                        </th>
                        <th>
                            {{ trans('cruds.project.fields.for_company') }}
                            @include('components.table.sort', ['field' => 'for_company.company_name'])
                        </th>
                        <th>
                            {{ trans('cruds.project.fields.workers') }}
                            @include('components.table.sort', ['field' => 'workers.name'])
                        </th>
                        <th>
                        </th>
                    </tr>
