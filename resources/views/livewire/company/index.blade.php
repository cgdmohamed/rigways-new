            ...
            <table class="table table-index w-full">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.company.fields.company_address') }}
                            @include('components.table.sort', ['field' => 'company_address'])
                        </th>
                        <th>
                            {{ trans('cruds.company.fields.company_phone') }}
                            @include('components.table.sort', ['field' => 'company_phone'])
                        </th>
                        <th>
                        ...
                        <th>
                            {{ trans('cruds.company.fields.company_description') }}
                            @include('components.table.sort', ['field' => 'company_description'])
                        </th>
                        <th>
                        </th>
                    </tr>
                ...
                <tbody>
                    @forelse($companies as $company)
                        <tr>
                            ...
                            <td>
                                <a class="link-light-blue" href="mailto:{{ $company->company_email }}">
